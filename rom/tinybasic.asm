...
ERRSTR   .text " AT "                ; " AT " string used in error reporting.  Tom was right about this.
...
;         .byte  "Open License Monitor, by Bill O'Neill V0.2.2"
         .text  "Open License Monitor, by Bill O'Neill V0.2.2"
         .byte  $0D, $0A, $0A
;         .byte  "TINY BASIC - Copyright, Tom Pitman"
         .text  "TINY BASIC - Copyright, Tom Pitman"
         .byte  $0D, $0A, $0A
;         .byte  "Boot (C/W)? "
         .text  "Boot (C/W)? "
         .byte  $07, $FF
