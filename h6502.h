...
const char *inst_addressing[256] = {
	IMP, INDX, NOP, NOP, NOP,  ZP,  ZP, NOP, IMP, IMM, ACC, NOP, NOP, ABS, ABS, NOP,
	REL, INDY, NOP, NOP, NOP, ZPX, ZPX, NOP, IMP, ABY, NOP, NOP, NOP, ABX, ABX, NOP,
	ABS, INDX, NOP, NOP,  ZP,  ZP,  ZP, NOP, IMP, IMM, ACC, NOP, ABS, ABS, ABS, NOP,
	REL, INDY, NOP, NOP, NOP, ZPX, ZPX, NOP, IMP, ABY, NOP, NOP, NOP, ABX, ABX, NOP,
	IMP, INDX, NOP, NOP, NOP,  ZP,  ZP, NOP, IMP, IMM, ACC, NOP, ABS, ABS, ABS, NOP,
	REL, INDY, NOP, NOP, NOP, ZPX, ZPX, NOP, IMP, ABY, NOP, NOP, NOP, ABX, ABX, NOP,
	IMP, INDX, NOP, NOP, NOP,  ZP,  ZP, NOP, IMP, IMM, ACC, NOP, IND, ABS, ABS, NOP,
	REL, INDY, NOP, NOP, NOP, ZPX, ZPX, NOP, IMP, ABY, NOP, NOP, NOP, ABX, ABX, NOP,
	NOP, INDX, NOP, NOP,  ZP,  ZP,  ZP, NOP, IMP, NOP, IMP, NOP, ABS, ABS, ABS, NOP,
	REL, INDY, NOP, NOP, ZPX, ZPX, ZPY, NOP, IMP, ABY, IMP, NOP, NOP, ABX, NOP, NOP,
	IMM, INDX, IMM, NOP,  ZP,  ZP,  ZP, NOP, IMP, IMM, IMP, NOP, ABS, ABS, ABS, NOP,
	REL, INDY, NOP, NOP, ZPX, ZPX, ZPY, NOP, IMP, ABY, IMP, NOP, ABX, ABX, ABY, NOP,
	IMM, INDX, NOP, NOP,  ZP,  ZP,  ZP, NOP, IMP, IMM, IMP, NOP, ABS, ABS, ABS, NOP,
	REL, INDY, NOP, NOP, NOP, ZPX, ZPX, NOP, IMP, ABY, NOP, NOP, NOP, ABX, ABX, NOP,
	IMM, INDX, NOP, NOP,  ZP,  ZP,  ZP, NOP, IMP, IMM, NOP, NOP, ABS, ABS, ABS, NOP,
	REL, INDY, NOP, NOP, NOP, ZPX, ZPX, NOP, IMP, ABY, NOP, NOP, NOP, ABX, ABX, NOP
};
